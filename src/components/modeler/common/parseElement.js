export const commonParse = (element) => {
	const result = {
...
export const formatJsonKeyValue = (result) => {
	// 移除flowable前缀，格式化数组
...
export const documentationParse = (obj) => {
...
export const conditionExpressionParse = (obj) => {
...
export const userTaskParse = (obj) => {
